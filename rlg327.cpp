...
int main(int argc, char *argv[])
{
 ...
 if (argc > 1) {
  ...
  //TESTING THE EQUPTIMENT SLOTS CAPACITY
  // printf("equiptmentSlots size:");
  //  std::cout << (int) d.PC->equiptmentSlots.capacity() << std::endl;

  //TESTING THE CARYY SLOTS CAPACITY
  //  printf("carrySlots size:");
  //  std::cout << (int) d.PC->carrySlots.capacity() << std::endl;
